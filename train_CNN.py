...
def train(args):
    ...
    wandb.init(project="CNN Blast Pressure Predictor", name=args.run_name, config=args)
    config = wandb.config
...
def launch():
    ...
    parser.add_argument("--run_name", type=str, default="CNN_Home_OG_dataset_l1_loss_log")
