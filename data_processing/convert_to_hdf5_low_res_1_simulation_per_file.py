...
def convert_simulation_to_hdf5(sim_dir, output_hdf5, probe_positions):
    ...
    if total_timesteps > 900:
        ...
        with h5py.File(output_hdf5, "w") as hdf5_file:
            ...
            hdf5_file.create_dataset("times", data=times, shape=(90,), chunks=(90,))
            hdf5_file.create_dataset("pressures", data=pressures, shape=(90, 99, 99), chunks=(90, 99, 99))
...
if __name__ == "__main__":
    ...
    output_hdf5_dir = "/home/reid/projects/blast_waves/hdf5_dataset_low_res_1_simulation_per_file_10_chunks"  
