...
def convert_simulation_to_hdf5(sim_dir, output_hdf5, probe_positions):
    ...
    if total_timesteps > 900:
        ...
        with h5py.File(output_hdf5, "w") as hdf5_file:
            ...
            hdf5_file.create_dataset("times", data=times, shape=(900,), chunks=(100,))
            hdf5_file.create_dataset("pressures", data=pressures, shape=(900, 99, 99), chunks=(100, 99, 99))
...
if __name__ == "__main__":
    ...
    output_hdf5_dir = "/home/reid/projects/blast_waves/hdf5_dataset_1_simulation_per_file_100_chunks"  
