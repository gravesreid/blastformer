...
def convert_simulation_to_hdf5(sim_dir, output_hdf5, probe_positions):
    ...
    if total_timesteps > 900:
        ...
        print(f'max_pressure_grid shape: {max_pressure_grid.shape}')
        pressures = pressures[::30]
        times = times[::30]
        ...
        with h5py.File(output_hdf5, "w") as hdf5_file:
            ...
            hdf5_file.create_dataset("times", data=times, shape=(30,), chunks=(30,))
            hdf5_file.create_dataset("pressures", data=pressures, shape=(30, 99, 99), chunks=(30, 99, 99))
...
if __name__ == "__main__":
    ...
    output_hdf5_dir = "/home/reid/projects/blast_waves/hdf5_dataset_ultra_low_res_1_simulation_per_file"  
